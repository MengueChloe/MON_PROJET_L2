<div class="flex flex-col gap-6">
    <x-auth-header :title="__('Connectez-vous à votre compte')" :description="__('Entrez votre adresse email et votre mot de passe pour vous connecter')" />
    ...
    <form method="POST" wire:submit="login" class="flex flex-col gap-6">
        ...
        <div class="flex items-center justify-end">
            <flux:button variant="danger" type="submit" class="w-full">{{ __('Se connecter') }}</flux:button>
        </div>
    </form>
