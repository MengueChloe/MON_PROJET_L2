...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-red-100 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    @if(auth()->user()->type === 'benevole')
                        <flux:navlist.item 
                            icon="users" 
                            :href="route('candidacies.index')" 
                            :current="request()->routeIs('candidacies.*')" 
                            wire:navigate>
                            {{ __('Candidatures') }}
                        </flux:navlist.item>
                    @endif
